...
Kirigami.Dialog {
        ...
        Controls.ScrollView {
            ...
            ColumnLayout {
                ...
                ListView {
                    id: accountList
                    Layout.fillWidth: true
                    Layout.preferredHeight: Math.min(accountList.contentHeight, 240)
                    interactive: false
                    clip: true
                ...
                Controls.Button {
                    ...
                    onClicked: {
                        ...
                        window.showPassiveNotification(qsTr("Signature saved"))
                    }
                }
    ...
    onOpened: Pelliper.DaemonClient.loadSenderPolicies()
